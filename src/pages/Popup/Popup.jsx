  ...
  return (
    <div className="container">
      <div className="row header">
        <div>{m`Setting`}</div>
        <div>
          <a title={m`contact_author`}><GithubIcon/></a>
        </div>
      </div>
      <div className="row">
        <input
